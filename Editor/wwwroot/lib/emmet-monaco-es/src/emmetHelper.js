 ...
 *--------------------------------------------------------------------------------------------*/
import expand, { extract, resolveConfig, stringifyMarkup, stringifyStylesheet, } from 'emmet';
 ...
 */
export function doComplete(monaco, model, position, syntax, emmetConfig) {
    var _a;
 ...
 */
export function registerCustomSnippets(syntax, customSnippets) {
    const baseSyntax = getDefaultSyntax(syntax);
