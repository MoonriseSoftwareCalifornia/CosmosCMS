...
export function emmetHTML(monaco = window.monaco, languages = ['html']) {
    return registerProvider(monaco, languages, 'html');
}
export function emmetCSS(monaco = window.monaco, languages = ['css']) {
    return registerProvider(monaco, languages, 'css');
}
export function emmetJSX(monaco = window.monaco, languages = ['javascript']) {
